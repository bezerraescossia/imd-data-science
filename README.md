...
- **Ano**: 2021.2
- **Professor**: [![Github](https://img.shields.io/badge/-Leonardo_Bezerra-EC1C24?style=social&logo=Github)](https://github.com/leobezerra?tab=repositories)
...
- confira os [![Github](https://img.shields.io/badge/-municípios-EC1C24?style=social&logo=Github)](https://github.com/bezerraescossia/imd-data-science/blob/main/municipios.txt) incluidos nesse estudo
...
O primeiro passo foi selecionar somente as features necessárias para o aprendizado de maquina, do nosso [![Outros](https://img.shields.io/badge/-Dataset-EC1C24?style=social&logo=giphy)](https://github.com/bezerraescossia/imd-data-science/blob/main/data/log.csv) foi selecionado somente a serie "texto".
